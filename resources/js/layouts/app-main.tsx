    ...
    return (
        <>
            <div className="brand-canvas min-h-screen font-sans text-brand-dark selection:bg-brand-blue selection:text-white">
                ...
                {!hideNav && (
                    <div className="fixed right-5 bottom-5 z-50 sm:right-7 sm:bottom-7 print:hidden">
                        <motion.button
            ...
            {/* Outside .brand-canvas: its `isolation: isolate` trapped the toaster's z-index below Radix Dialogs, which portal straight to document.body. */}
            <Toaster
                theme="light"
                position="top-right"
                expand={true}
